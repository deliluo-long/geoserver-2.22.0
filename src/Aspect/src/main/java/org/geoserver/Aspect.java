...
@DescribeProcess(title = "Aspect", description = "坡向分析")
public class Aspect implements GeoServerProcess {
    public Aspect() {}
    ...
    @DescribeResult(name = "outputGridCoverage", description = "输出坡向分析结果")
    public GridCoverage2D execute(
        ...
        try {
            convertToTiff(
                    inputGridCoverage,
                    "./src/main/webapp/data/python/calc_aspect/inputGridCoverage.tif");
            ...
            ProcessBuilder pb =
                    new ProcessBuilder(
                            ...
                            "./src/main/webapp/data/python/calc_Aspect.py");
            // 启动进程
            ...
            if (exitCode == 0) {
                ...
                File file =
                        new File(
                                "./src/main/webapp/data/python/calc_aspect/outputGridCoverage.tif");
                ...
                GridCoverage2D outputGridCoverage = (GridCoverage2D) fileReader.read(null);
                // 关闭资源
                fileReader.dispose();
