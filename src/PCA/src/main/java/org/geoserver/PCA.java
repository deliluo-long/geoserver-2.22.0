...
public class PCA implements GeoServerProcess {
    ...
    public String execute(
        ...
        if (raster2 != null) {
            convertToTiff(raster2, "./src/main/webapp/data/python/PCA/inputGridCoverage2.tif");
            rasterNameList.add(rasterName2);
        }
        if (raster3 != null) {
            convertToTiff(raster3, "./src/main/webapp/data/python/PCA/inputGridCoverage3.tif");
            rasterNameList.add(rasterName3);
        }

        if (raster4 != null) {
            convertToTiff(raster4, "./src/main/webapp/data/python/PCA/inputGridCoverage4.tif");
            rasterNameList.add(rasterName4);
        }
        if (raster5 != null) {
            convertToTiff(raster5, "./src/main/webapp/data/python/PCA/inputGridCoverage5.tif");
            rasterNameList.add(rasterName5);
        }

        if (raster6 != null) {
            convertToTiff(raster6, "./src/main/webapp/data/python/PCA/inputGridCoverage6.tif");
            rasterNameList.add(rasterName6);
        }

        if (raster7 != null) {
            convertToTiff(raster7, "./src/main/webapp/data/python/PCA/inputGridCoverage7.tif");
            rasterNameList.add(rasterName7);
        }
        if (raster8 != null) {
            convertToTiff(raster8, "./src/main/webapp/data/python/PCA/inputGridCoverage8.tif");
            rasterNameList.add(rasterName8);
        }

        if (raster9 != null) {
            convertToTiff(raster9, "./src/main/webapp/data/python/PCA/inputGridCoverage9.tif");
            rasterNameList.add(rasterName9);
        }

        if (raster10 != null) {
            convertToTiff(raster10, "./src/main/webapp/data/python/PCA/inputGridCoverage10.tif");
