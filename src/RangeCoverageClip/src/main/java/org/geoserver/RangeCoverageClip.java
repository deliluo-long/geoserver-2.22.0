...
public class RangeCoverageClip implements GeoServerProcess {
    ...
    public GridCoverage2D execute(@DescribeParameter(name = "inputGridCoverage",description = "输入待裁剪数据") GridCoverage2D inputGridCoverage, @DescribeParameter(name = "clipBoundry",description = "输入裁剪范围") SimpleFeatureCollection clipBoundary) throws Exception {
